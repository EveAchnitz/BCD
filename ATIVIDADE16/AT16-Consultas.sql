...
-- 1
SELECT COUNT(CPF) AS Cadastrados FROM funcionarios
WHERE Salario > 4000;
...
-- 4
SELECT COUNT(Codigo) AS Funcionarios FROM funcionarios
WHERE SegundoNome OR UltimoNome LIKE 'Oliveira';
...
-- 6
SELECT COUNT(Codigo) AS numero_funcionarios FROM funcionarios
WHERE Salario != 3800;

-- 7
SELECT MIN(Salario) AS salario_minimo FROM funcionarios
WHERE CPF IS NULL;
...
-- 9
SELECT COUNT(Codigo) AS Funcionarios FROM funcionarios
WHERE Funcao LIKE 'Gerente' AND Salario = 5000;
...
-- 11
SELECT AVG(Salario) AS media_salarios FROM funcionarios
WHERE Funcao LIKE 'Desenvolvedor' OR Salario > 4200;

-- 12
SELECT COUNT(Codigo) AS Funcionarios FROM funcionarios
WHERE SegundoNome OR UltimoNome LIKE 'Almeida' OR Salario < 3500;

-- 13
SELECT MIN(Salario) AS salario_minimo FROM funcionarios
WHERE Funcao LIKE 'Designer' AND CPF IS NOT NULL;

-- 14
SELECT SUM(Salario) AS soma_salarios FROM funcionarios
WHERE Funcao LIKE 'Analista' OR Salario > 4000;

-- 15
SELECT COUNT(Codigo) AS Funcionarios FROM funcionarios
WHERE Salario = 3600 OR Cidade LIKE 'Curitiba';